...
using Trace = ItPlanet.Tracing.Trace;

internal class Program
{
    public static ActivitySource MyActivitySource = new("It planet");
...
builder.Services.AddDbContext<ApiDbContext>(optionsBuilder => optionsBuilder.UseNpgsql(connectionString));
        ...
        using var tracerProvider = Trace.InitializeTracing("It planet", "1.0.0");
